...
Listado.prototype.buscarRestaurante = function(idRest) {
...
Listado.prototype.obtenerUbicaciones = function() {
    ...
    this.restaurantes.map(function(restaurant){
        return ciudadesArray.push(restaurant.ubicacion);
    });
    ...
    // return c2.sort();
     ...
     var arrayDeCiudadesSinRepetirse = removeDuplicatesArray(ciudadesArray);
