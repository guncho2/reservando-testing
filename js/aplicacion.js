...
// Cuando hablamos de dibujar, nos referimos a crear
...
Aplicacion.prototype.dibujarListado = function(restaurantes) {
    ...
    //Si no se recibe ningún restaurante por parámetro (porque los filtros aplicados no 
    //retornaron ningún resultado) se crea un elemento
...
Aplicacion.prototype.crearTarjetaDeRestaurante = function(restaurant) {
    ...
    //Buscamos el elemento que se corresponde con la puntuación y le registramos
    // al evento click, la funcionalidad de calificar un restaurant
    ...
    //Por cada horario de un restaurant, creamos el elemento HTML que va a mostrarlo. 
    //Además le asignamos la funcionalidad de reservar un restaurant.
...
//En el caso de que la calificación sea válida, se ejecuta la función de calificarRestaurant()
// del listado. Luego, se busca en el HTML el restaurant que
...
//Función que se encarga de pedirle al listado que filtre los restaurantes y 
//de actualizar el HTML con los resultados de la búsqueda.
//Las opciones "Default" y "Todos" de los filtros, tienen como propiedad val un 1 
//y un 0. En el caso de que el la propiedad val de alguno
//de los filtros sea 0 o 1, se envía como filtro el valor null, para que el listado 
//sepa que no tiene que filtrar por ese campo.
